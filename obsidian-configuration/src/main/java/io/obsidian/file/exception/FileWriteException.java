...
/**
 * Thrown when a write operation on the filesystem fails.
 *
 * <p>Covers text writes, byte writes, line writes, object serialization,
 * append operations, and file creation.</p>
 *
 * @since 1.0
 */
