...
public final class JsonFiles {
    ...
    /**
     * Reads and decodes a JSON file into a Java object using the default JSON mapper.
     *
     * @param <T> the target type
     ...
     * @throws JsonIoException if file I/O fails
     * @throws JsonParseException if parsing the JSON fails
     * @throws JsonMappingException if mapping the JSON to the target type fails
     * @throws IllegalArgumentException if path or type is null
     */
    public static <T> T read(String path, TypeReference<T> type) {
        return read(Path.of(path), type, DEFAULT_MAPPER);
    }
    ...
    /**
     * Reads and decodes a JSON file into a Java object using a custom JSON mapper.
     *
     * @param <T> the target type
     * @param path the file path as a string
     * @param type the type reference for the target object
     * @param mapper the JSON mapper to use for decoding
     * @return the decoded object of type T
     * @throws JsonIoException if file I/O fails
     * @throws JsonParseException if parsing the JSON fails
     * @throws JsonMappingException if mapping the JSON to the target type fails
     * @throws IllegalArgumentException if any parameter is null
     */
    public static <T> T read(String path, TypeReference<T> type, JsonMapper mapper) {
        return read(Path.of(path), type, mapper);
    }
    ...
    /**
     * Parses a JSON file into a JsonElement tree using the given file path as a string.
     *
    ...
    /**
     * Parses a JSON file into a JsonElement tree using the given file path as a string and a custom JSON mapper.
     *
     * @param path the file path to the JSON file
     ...
     * @throws JsonIoException if file I/O fails
     * @throws JsonParseException if parsing the JSON fails
     * @throws IllegalArgumentException if the path or mapper is null
     */
    public static JsonElement parse(String path, JsonMapper mapper) {
        return parse(Path.of(path), mapper);
    }
    ...
    /**
     * Writes an object to a JSON file using the file path as a string.
     *
     * @param path the file path as a string
     * @param value the object to write
     * @throws JsonIoException if file I/O fails
    ...
    public static void write(Path path, Object value, JsonMapper mapper) {
        ...
        String json = Json.configure().build().toJson(value);
    ...
    /**
     * Writes an object to a JSON file using the provided file path as a string
     * and a custom JSON mapper.
     *
     * @param path the file path as a string
     * @param value the object to write
     * @param mapper the JSON mapper to use for writing the object
     * @throws JsonIoException if file I/O fails
     * @throws JsonMappingException if encoding fails
     * @throws IllegalArgumentException if the path or mapper is null
     */
    public static void write(String path, Object value, JsonMapper mapper) {
        write(Path.of(path), value, mapper);
    }
