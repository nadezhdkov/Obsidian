...
import obsidian.json.util.JsonSerializer;
...
public final class JsonConfig {
    ...
    /**
     * Converts the given object to its JSON representation based on the current configuration.
     *
     * @param object the object to be converted to JSON. Must not be null.
     * @return a JSON string representing the serialized form of the given object.
    ...
    /**
     * Parses the given JSON string into an instance of the specified type.
     *
     * @param <T> the type of the object to be returned
     * @param json the JSON string to parse. Must not be null.
     * @param type the target class type for the parsed object. Must not be null.
     * @return an instance of the specified type, populated with the data from the JSON string
     * @throws JsonParseException if the JSON string is invalid
     * @throws JsonMappingException if mapping the JSON to the specified type fails
     * @throws IllegalArgumentException if either the JSON string or the class type is null
     */
    public <T> T parseJson(@NotNull String json, @NotNull Class<T> type) {
        JsonMapper  mapper  = Json.defaultMapper();
        JsonElement element = mapper.parse(JsonSource.of(json));
        return mapper.decode(element, TypeReference.of(type));
    }
